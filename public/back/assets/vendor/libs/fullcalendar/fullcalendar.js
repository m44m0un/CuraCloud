!(function (e, t) {
  ...
  return (function () {
    ...
    let Ne;
    "undefined" != typeof document && Oe(document);
    Me(
    ...
    function vn(e, t, n = {}) {
      if (e === t) return !0;
      for (let r in t) if (!(r in e) || !yn(e[r], t[r], n[r])) return !1;
    ...
    function Cn(e) {
      ...
      for (
        r.debounceRendering = function (e) {
          ...
          U(m(Rn, {}), document.createElement("div"));
        n.length;
    ...
    (wn.prototype.classes = {}),
      (wn.prototype.iconClasses = {}),
      (wn.prototype.baseIconClass = ""),
      (wn.prototype.iconOverridePrefix = "");
    class Rn extends D {
      render() {
        return m("div", {});
      }
    ...
    function kn(e, t, n, r, i, s, o, a, l, c, d, u, h) {
      return {
        ...
        createScrollResponder(e) {
          return new xn(e, c, lt(n.scrollTime), n.scrollTimeReset);
        },
    ...
    class Mn extends D {
      shouldComponentUpdate(e, t) {
        return (
          this.debug && console.log(mn(e, this.props), mn(t, this.state)),
          !vn(this.props, e, this.propEquality) ||
            !vn(this.state, t, this.stateEquality)
        );
      }
      safeSetState(e) {
        vn(
    ...
    class Nn extends On {
      constructor() {
        super(...arguments),
          ...
          (this.handleEl = (e) => {
            Pn(this.props.generatorName, this.context.options) ||
              this.updateElRef(e);
          }),
          (this.updateElRef = (e) => {
          ...
          r &&
            i(
              Object.assign(
                ...
                { elClasses: (n.elClasses || []).filter(Bn) }
              )
            );
        }
      }
    ...
    class zn extends D {
      constructor() {
        super(...arguments),
          (this.InnerContent = Un.bind(void 0, this)),
          (this.handleEl = (e) => {
            (this.el = e), this.props.elRef && In(this.props.elRef, e);
          });
      }
      render() {
        const { props: e } = this,
    ...
    class Ln extends On {
      render() {
        ...
        return m(
          ...
          Object.assign({}, e, {
            elTag: e.elTag || "div",
            elClasses: [...Wn(e.viewSpec), ...(e.elClasses || [])],
            renderProps: r,
    ...
    function Fn(e, t) {
      let n,
        ...
        i = [],
        { start: s } = t;
      for (e.sort(Vn), n = 0; n < e.length; n += 1)
        (r = e[n]),
    ...
    class Kn {
      constructor(e) {
        (this.props = e),
          (this.nowDate = Jn(e.nowInput, e.dateEnv)),
          this.initHiddenDays();
      }
      buildPrev(e, t, n) {
      ...
      build(e, t, n = !0) {
        ...
        return (
          ...
          (a = o),
          c.showNonCurrentDates || (a = Gn(a, i.range)),
    ...
    function tr(e, t, n) {
      ...
      for (let e in o) {
        ...
        if (n.recurringDef) {
          ...
          let l = nr(n, o, t, r, i.recurringTypes);
          for (let t of l) {
            let n = er(e, { start: t, end: r.add(t, o) });
            a[n.instanceId] = n;
          }
        }
      }
    ...
    const rr = {
      ...
      ir = { start: an, end: an, date: an, allDay: Boolean },
      sr = Object.assign(Object.assign(Object.assign({}, rr), ir), {
        extendedProps: an,
      });
    function or(e, t, n, r, i = lr(n), s, o) {
      ...
      if (u) {
        let e = cr(a, l, t ? t.sourceId : "", u.allDay, u.hasEnd, n, s),
          r = er(e.defId, u.range, u.forcedStartTzo, u.forcedEndTzo);
        return (
    ...
    function lr(e) {
      return Object.assign(
        Object.assign(Object.assign({}, mr), sr),
    ...
    function Dr(e) {
      return Object.assign(
        Object.assign(Object.assign({}, mr), Ar),
    ...
    function wr(e, t, n, r, i) {
      switch (t.type) {
        case "RECEIVE_EVENTS":
          return (function (e, t, n, r, i, s) {
            if (t && n === t.latestFetchId) {
              let n = dr(Cr(i, t, s), t, s);
              return r && (n = tr(n, r, s)), fr(xr(e, t.sourceId), n);
            }
            return e;
        ...
        case "RESET_EVENTS":
          return t.eventStore;
        case "MERGE_EVENTS":
          return fr(e, t.eventStore);
        case "PREV":
        case "NEXT":
        case "CHANGE_DATE":
        case "CHANGE_VIEW_TYPE":
          return r ? tr(e, r.activeRange, i) : e;
        case "REMOVE_EVENTS":
          return (function (e, t) {
        ...
        case "REMOVE_EVENT_SOURCE":
          return xr(e, t.sourceId);
        case "REMOVE_ALL_EVENT_SOURCES":
          return gr(e, (e) => !e.sourceId);
    ...
    function Cr(e, t, n) {
      ...
      return i && (e = Rr(e, i)), r && (e = Rr(e, r)), e;
    }
    function Rr(e, t) {
      let n;
      if (t) {
    ...
    function Ir(e, t) {
      ...
      return (
        Object.assign(
          ...
          ((r = e),
          (i = t.dateEnv),
          Object.assign(Object.assign({}, oi(r.range, i, r.allDay)), {
            allDay: r.allDay,
          }))
        ),
        n
    ...
    const ri = { start: an, end: an, allDay: Boolean };
    function ii(e, t, n) {
      let r = (function (e, t) {
          let { refined: n, extra: r } = on(e, ri),
    ...
    function si(e, t, n) {
      return Object.assign(Object.assign({}, oi(e, t, n)), {
        timeZone: t.timeZone,
      });
    }
    function oi(e, t, n) {
    ...
    class di extends On {
      ...
      render() {
        ...
        return ci() || s.push("fc-liquid-hack"), e.children(s, i, r, n);
      }
      componentDidMount() {
    ...
    class gi {
      ...
      today() {
        ...
        this.unselect(),
          this.dispatch({
            type: "CHANGE_DATE",
            dateMarker: Jn(e.calendarOptions.now, e.dateEnv),
          });
      }
      gotoDate(e) {
      ...
      addEvent(e, t) {
        if (e instanceof zr) {
          ...
          return (
            this.getCurrentData().eventStore.defs[t.defId] ||
              (this.dispatch({
                type: "ADD_EVENTS",
                eventStore: ur({ def: t, instance: n }),
              }),
        ...
        if (i) {
          ...
          return (
            this.dispatch({ type: "ADD_EVENTS", eventStore: ur(i) }),
            this.triggerEventAdd(e),
            e
          );
        }
    ...
    class yi {
      ...
      splitProps(e) {
        ...
        this.eventUiBuilders = un(
          t,
          (e, t) => this.eventUiBuilders[t] || Nt(bi)
        );
        for (let n in t) {
          let c = t[n],
            d = s[n] || vi,
        ...
        if (e) {
          let n = this._splitEventStore(
            ...
            s = (r) => {
              t[r] ||
                (t[r] = {
                  affectedEvents: n[r] || vi,
                  mutatedEvents: i[r] || vi,
                  isEvent: e.isEvent,
                });
            };
          for (let e in n) s(e);
    ...
    const Si = Zt({ year: "numeric", month: "long", day: "numeric" }),
      Di = Zt({ week: "long" });
    function wi(e, t, n = "day", r = !0) {
      const { dateEnv: i, options: s, calendarApi: o } = e;
      let a = i.format(t, "week" === n ? Di : Si);
      if (s.navLinks) {
        let e = i.toDate(t);
        const l = (e) => {
          let r =
    ...
    function ki(e, t = !1, n) {
      let r = n ? e.getBoundingClientRect() : Mi(e),
        i = (function (e, t = !1) {
    ...
    class Ii {
      ...
      similarTo(e) {
        return (
          Ni(this.tops || [], e.tops || []) &&
          Ni(this.bottoms || [], e.bottoms || []) &&
          Ni(this.lefts || [], e.lefts || []) &&
          Ni(this.rights || [], e.rights || [])
        );
      }
    }
    function Ni(e, t) {
    ...
    class zi {
      ...
      splitEntry(e, t, n) {
        ...
        return (
          ...
          r
            ? (n.push(
                { index: e.index, thickness: e.thickness, span: Wi(o, s) },
                ...i
              ),
              r)
            : (n.push(e), 0)
      ...
      insertEntryAt(e, t) {
        ...
        -1 === t.lateral
          ...
          (this.stackCnts[Li(e)] = t.stackCnt);
      }
      findInsertion(e) {
        let {
            levelCoords: t,
        ...
        let h = -1;
        return (
          u < s && t[u] === o && (h = Vi(n[u], e.span.end, Ui)[0]),
          {
            touchingLevel: a,
            touchingLateral: l,
            touchingEntry: c,
            ...
            elAttrs: Object.assign(
              {
                role: "columnheader",
                colSpan: i.colSpan,
                "data-date": a.isDisabled ? void 0 : Ot(s),
              },
              i.extraDataAttrs
            ),
            renderProps: u,
    ...
    class $i extends On {
      render() {
        ...
        return m(
          ...
          {
            elTag: "th",
            elClasses: [Yi, ...Ai(o, n), ...(e.extraClassNames || [])],
            elAttrs: Object.assign(
    ...
    class Ji extends D {
      constructor(e, t) {
        super(e, t),
          (this.initialNowDate = Jn(t.options.now, t.dateEnv)),
    ...
    class es extends On {
      constructor() {
        super(...arguments), (this.createDayHeaderFormatter = Nt(ts));
      }
      render() {
        let { context: e } = this,
          {
    ...
    class is {
      ...
      _sliceBusinessHours(e, t, n, r, ...i) {
        return e
          ? this._sliceEventStore(tr(e, ss(t, Boolean(n)), r), {}, t, n, ...i)
              .bg
          : [];
      }
      _sliceEventStore(e, t, n, r, ...i) {
        if (e) {
          let s = Wr(e, t, ss(n, Boolean(r)), r);
          return {
      ...
      _sliceInteraction(e, t, n, r, ...i) {
        if (!e) return null;
        let s = Wr(e.mutatedEvents, t, ss(n, Boolean(r)), r);
        return {
      ...
      _sliceDateSpan(e, t, n, r, i, ...s) {
        if (!e) return [];
        let o = ss(t, Boolean(n)),
          a = Gn(e.range, o);
        if (a) {
          let t = (function (e, t, n) {
              let r = ar({ editable: !1 }, n),
                i = cr(r.refined, r.extra, "", e.allDay, !0, n);
              return {
                def: i,
                ui: Qr(i, t),
                instance: er(i.defId, e.range),
                range: e.range,
                isStart: !0,
                isEnd: !0,
              };
    ...
    function os(e, t, n) {
      ...
      for (let e in r) if (!Yn(t.validRange, r[e].range)) return !1;
      return as({ eventDrag: e }, n);
    }
    function as(e, t) {
      ...
      return (t.pluginHooks.isPropsValid || ls)(r, t);
    }
    function ls(e, t, n = {}, r) {
      return (
        !(
          ...
          !(function (e, t, n, r) {
            ...
            for (let r in l) {
              let o = l[r],
                ...
                p = c[o.defId],
                m = a[o.defId];
              if (!cs(p.constraints, g, d, e.businessHours, t)) return !1;
              ...
              for (let e of p.allows) {
                let i,
                  ...
                  a = b.defs[m.defId],
                  l = b.instances[r];
                if (((i = a ? new zr(t, a, l) : new zr(t, m)), !e(Ir(s, t), i)))
                  return !1;
              }
            }
            return !0;
        ...
        !(
          ...
          !(function (e, t, n, r) {
            ...
            r && (c = r(c));
            if (!cs(c.constraints, l, i, e.businessHours, t)) return !1;
    ...
    function cs(e, t, n, r, i) {
      for (let s of e) if (!hs(ds(s, t, n, r, i), t)) return !1;
      return !0;
    }
    ...
    function hs(e, t) {
      for (let n of e) if (Yn(n, t)) return !0;
      return !1;
    }
    const fs = /^(visible|hidden)$/;
    class gs extends On {
      constructor() {
        super(...arguments),
          (this.handleEl = (e) => {
      ...
      needsXScrolling() {
        if (fs.test(this.props.overflowX)) return !1;
        let { el: e } = this,
      ...
      needsYScrolling() {
        if (fs.test(this.props.overflowY)) return !1;
        let { el: e } = this,
          t =
      ...
      getXScrollbarWidth() {
        return fs.test(this.props.overflowX)
          ? 0
          : this.el.offsetHeight - this.el.clientHeight;
      }
      getYScrollbarWidth() {
        return fs.test(this.props.overflowY)
          ? 0
      ...
      for (let r of e) {
        ...
        for (let i = 0; i < e; i += 1)
          n.push(
            m("col", {
              style: {
                width: "shrink" === r.width ? Es(t) : r.width || "",
                minWidth: r.minWidth || "",
              },
            })
          );
    ...
    class Cs extends On {
      constructor() {
        super(...arguments),
          (this.processCols = Nt((e) => e, ys)),
          (this.renderMicroColGroup = Nt(bs)),
          (this.scrollerRefs = new ps()),
          (this.scrollerElRefs = new ps(this._handleScrollerEl.bind(this))),
          (this.state = {
            shrinkWidth: null,
            forceYScrollbars: !1,
    ...
    class Rs extends On {
      constructor() {
        super(...arguments),
          (this.handleEl = (e) => {
            (this.el = e), e && Fr(e, this.props.seg);
          });
      }
      render() {
        const { props: e, context: t } = this,
          ...
          o = {
            ...
            isEndResizable: !e.disableResizing && $r(r),
            isMirror: Boolean(
      ...
      componentDidUpdate(e) {
        this.el && this.props.seg !== e.seg && Fr(this.el, this.props.seg);
      }
    }
    class _s extends On {
      render() {
    ...
    class Ms extends On {
      ...
      render() {
        ...
        return m(
          zn,
          Object.assign({}, e, {
            elClasses: [...Ai(r, t.theme), ...(e.elClasses || [])],
            elAttrs: Object.assign(
              Object.assign({}, e.elAttrs),
              r.isDisabled ? {} : { "data-date": Ot(e.date) }
            ),
            renderProps: r,
      ...
      updateSize() {
        let { isRtl: e } = this.context,
          ...
          i = (function (e) {
            ...
            for (let e of t) {
              let t = mi(n, e.getBoundingClientRect());
              if (!t) return null;
              n = t;
            }
            return n;
    ...
    function Fs(e) {
      ...
      return {
        start: Vs(t),
        end: ((n = t), n.reduce(Qs).eventRange.range.end),
      };
      var n;
    }
    function Vs(e) {
    ...
    const Ys = [],
      ...
      Zs = Object.assign(Object.assign({}, qs), {
        buttonHints: {
          prev: "Previous $0",
          next: "Next $0",
          today(e, t) {
    ...
    function so(e) {
      ...
      return (
        t.content
          ? (n = oo(t))
          : !n ||
            n.prototype instanceof On ||
            (n = oo(Object.assign(Object.assign({}, t), { content: n }))),
        { superType: t.type, component: n, rawOptions: t }
      );
    }
    function oo(e) {
      return (t) =>
        m(Tn.Consumer, null, (n) =>
          m(zn, {
            elTag: "div",
            elClasses: Wn(n.viewSpec),
    ...
    function ao(e, t, n, r) {
      let i = io(e),
        ...
        o = (function (e, t) {
          let n,
            r = {};
          for (n in e) ro(n, r, e, t);
          for (n in t) ro(n, r, e, t);
          return r;
        })(i, s);
      return un(o, (e) =>
        (function (e, t, n, r, i) {
    ...
    function uo(e, t, n, r) {
      ...
      switch (t.type) {
        ...
        case "FETCH_EVENT_SOURCES":
          return po(
            e,
            t.sourceIds ? hn(t.sourceIds) : vo(e, r),
            i,
            t.isRefetch || !1,
            r
          );
    ...
    function fo(e, t, n, r) {
      ...
      return n && (i = go(i, n, r)), Object.assign(Object.assign({}, e), i);
    }
    function go(e, t, n) {
      return po(
        e,
    ...
    const xo = [
                  ...
                  fetch(t, r).then((e) => {
                    if (e.ok)
                      return e.json().then(
                        (t) => [t, e],
                        () => {
                          throw new ai("Failure parsing JSON", e);
                        }
                      );
                    throw new ai("Request failed", e);
                  })
                );
        ...
        recurringTypes: [
          {
            ...
            expand(e, t, n) {
              let r = Gn(t, { start: e.startRecur, end: e.endRecur });
              return r
                ? (function (e, t, n, r) {
                    let i = e ? hn(e) : null,
                      s = St(n.start),
      ...
      Ks({
        name: "misc",
        isLoadingFuncs: [(e) => ho(e.eventSources)],
        propSetHandlers: {
    ...
    class Mo {
      constructor(e) {
        (this.computeCurrentViewData = Nt(this._computeCurrentViewData)),
          (this.organizeRawLocales = Nt(Xs)),
          (this.buildLocale = Nt($s)),
          (this.buildPluginHooks = eo()),
          (this.buildDateEnv = Nt(Oo)),
          (this.buildTheme = Nt(Io)),
          (this.parseToolbars = Nt(Do)),
          (this.buildViewSpecs = Nt(ao)),
        ...
        let s = (function (e, t) {
            let n = e.initialDate;
            return null != n ? t.createMarker(n) : Jn(e.now, t);
      ...
      _handleAction(e) {
        ...
        this.data &&
          ...
          ("PREV" !== e.type && "NEXT" !== e.type && qn(d.currentRange, c)) ||
            (c = d.currentRange.start);
        let u = uo(n.eventSources, e, d, l),
          h = wr(n.eventStore, e, u, d, l),
          f =
            (ho(u) &&
        ...
        if (a && a !== l) {
          a.timeZone !== l.timeZone &&
            ((t.eventSources = s.eventSources =
              (function (e, t, n) {
                let r = t ? t.activeRange : null;
                return po(e, vo(e, n), r, !0, n);
              })(s.eventSources, t.dateProfile, s)),
            (t.eventStore = s.eventStore =
              _r(s.eventStore, n.dateEnv, s.dateEnv)),
            (t.renderableEventStore = s.renderableEventStore =
              _r(s.renderableEventStore, n.dateEnv, s.dateEnv)));
          for (let e in o)
        ...
        for (let e in s)
          s[e] === l[e] || (en[e] && en[e](s[e], l[e]))
            ...
            : (s[e] === this.currentCalendarOptionsInput[e] ||
              (en[e] && en[e](s[e], this.currentCalendarOptionsInput[e]))
    ...
    function No(e) {
      return new (e.dateProfileGeneratorClass || Kn)(e);
    }
    function Po(e, t, n) {
      return new Ro(e, t, n);
    }
    ...
    class Xo extends gi {
      constructor(e, t = {}) {
        super(),
          ...
          (function (e) {
            e.isConnected && Oe(e.getRootNode());
          })(e),
          (this.el = e),
    ...
    class ra extends On {
      render() {
        let { props: e, context: t } = this,
          { options: n } = t,
          { seg: r } = e,
          i = Jr(r, n.eventTimeFormat || ea, t, !0, e.defaultDisplayEventEnd);
        return m(
          Rs,
          Object.assign({}, e, {
            elTag: "a",
    ...
    class sa extends On {
      constructor() {
        super(...arguments), (this.compileSegs = Nt(oa));
      }
      render() {
        let { props: e } = this,
        ...
        return m(
          ...
          (s, a) =>
            m(
              ...
              !a.isDisabled && (t.showDayNumber || Os(i) || t.forceDayTop)
                ? m(
                    "div",
              ...
              (d += r.levelCoord - c),
                ...
                s
                  ? ((d += r.thickness),
                    o &&
                      u.push({
                        seg: fa(i, r.span.start, r.span.end, n),
                        isVisible: !0,
                        isAbsolute: !0,
                        absoluteTop: r.levelCoord,
                        marginTop: 0,
    ...
    function fa(e, t, n, r) {
      ...
      let i = e.eventRange,
        s = i.range,
        o = Gn(s, { start: r[t].date, end: yt(r[n - 1].date, 1) });
      return Object.assign(Object.assign({}, e), {
        firstCol: t,
        lastCol: n - 1,
        eventRange: {
          ...
          if (!i[e])
            if (this.allowReslicing) {
              const e = Object.assign(Object.assign({}, s), {
                span: Wi(s.span, t.span),
              });
              (i[Li(e)] = !0), (r[o][a] = e), this.splitEntry(s, t, n);
            } else (i[e] = !0), n.push(s);
        }
    ...
    class pa extends ji {
      constructor() {
        super(...arguments),
          (this.cellElRefs = new ps()),
          (this.frameElRefs = new ps()),
          (this.fgElRefs = new ps()),
          (this.segHarnessRefs = new ps()),
          (this.rootElRef = { current: null }),
          (this.state = {
            framePositions: null,
              ...
              h.push(
                m(
                  "div",
                  {
                    ...
                    key: da(t),
                    ref: u ? null : this.segHarnessRefs.createRef(ua(t)),
                    style: {
                      visibility: g ? "" : "hidden",
          ...
          for (let o of e) {
            ...
            s.push(
              m(
                ...
                "bg-event" === t
                  ? m(Ns, Object.assign({ seg: o }, Kr(o, r)))
                  : Hs(t)
              )
            );
          }
    ...
    pa.addStateEquality({ segHeights: gn });
    class ma extends ji {
      constructor() {
        super(...arguments),
          (this.splitBusinessHourSegs = Nt($o)),
          (this.splitBgEventSegs = Nt($o)),
          (this.splitFgEventSegs = Nt($o)),
          (this.splitDateSelectionSegs = Nt($o)),
          (this.splitEventDrag = Nt(Ko)),
          (this.splitEventResize = Nt(Ko)),
          (this.rowRefs = new ps());
      }
      render() {
        let { props: e, context: t } = this,
          ...
          const e = (function (e, t) {
            ...
            t.currentRangeUnit.match(/year|month/) &&
              (n = e.querySelector(
                `[data-date="${
                  ((r = t.currentDate),
                  r.toISOString().match(/^\d{4}-\d{2}/)[0])
                }-01"]`
              ));
            var r;
            n || (n = e.querySelector(`[data-date="${Ot(t.currentDate)}"]`));
            return n;
    ...
    var Da = Ks({
      ...
      views: {
        dayGrid: {
          ...
          dateProfileGeneratorClass: class extends Kn {
            buildRenderRange(e, t, n) {
    ...
    const Ia = "function" == typeof performance ? performance.now : Date.now;
    class Na {
      constructor() {
        (this.isEnabled = !0),
      ...
      handleMove(e, t) {
        if (this.isEnabled) {
          ...
          i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
            ...
            this.isAnimating ||
              ((this.isAnimating = !0), this.requestAnimation(Ia()));
        }
      }
      stop() {
        if (this.isEnabled) {
    ...
    class Ha {
      constructor(e) {
        (this.origRect = Mi(e)),
          (this.scrollCaches = Oi(e).map((e) => new Ma(e, !0)));
      }
      destroy() {
        for (let e of this.scrollCaches) e.destroy();
      }
      ...
      isWithinClipping(e, t) {
        ...
        for (let e of this.scrollCaches)
          if (!Ba(e.getEventTarget()) && !pi(n, e.clientRect)) return !1;
        return !0;
      }
    }
    function Ba(e) {
        ...
        for (let s in n) {
          ...
          if (a && a.isWithinClipping(e, t)) {
            ...
            if (l >= 0 && l < u && c >= 0 && c < h) {
              ...
              e &&
                Yn(e.dateProfile.activeRange, e.dateSpan.range) &&
                (!i || e.layer > i.layer) &&
                ((e.componentId = s),
                (e.context = o.context),
                (e.rect.left += n),
      ...
      constructor(e) {
        super(e),
          ...
          (this.handlePointerDown = (e) => {
            ...
            (this.relevantEvents = hr(o.getCurrentData().eventStore, l)),
        ...
        let i = (this.hitDragging = new ja(this.dragging, fi));
      ...
      componentInteractions: [
        class extends ui {
          constructor(e) {
            ...
            let t = (this.hitDragging = new ja(this.dragging, hi(e)));
        ...
        class extends ui {
          constructor(e) {
            super(e),
                ...
                if (e) {
                  ...
                  (e.componentId === t.componentId &&
                    ...
                    (r &&
                      (function (e, t, n) {
                        return (
                          !!Yn(t.validRange, e.range) &&
                          as({ dateSelection: e }, n)
                        );
                      })(r, e.dateProfile, n)) ||
                      ((i = !0), (r = null));
                }
              ...
              (this.handlePointerUp = (e) => {
                this.dragSelection &&
                  (Or(this.dragSelection, e, this.component.context),
                  (this.dragSelection = null));
              });
            let { component: t } = e,
              { options: n } = t.context,
            ...
            (r.touchScrollAllowed = !1),
              ...
              (r.autoScroller.isEnabled = n.dragScroll);
            let i = (this.hitDragging = new ja(this.dragging, hi(e)));
            i.emitter.on("pointerdown", this.handlePointerDown),
              i.emitter.on("dragstart", this.handleDragStart),
              i.emitter.on("hitupdate", this.handleHitUpdate),
              i.emitter.on("pointerup", this.handlePointerUp);
        ...
        class extends ui {
          constructor(e) {
            ...
            let r = (this.hitDragging = new ja(this.dragging, hi(e)));
    ...
    class Ga extends On {
      ...
      render() {
        ...
        return m(
          ...
          {
            elTag: "tr",
            elClasses: ["fc-list-day", ...Ai(l, e)],
            elAttrs: { "data-date": Ot(s) },
            renderProps: u,
            generatorName: "dayHeaderContent",
                ...
                for (let n = 0; n < a.length; n += 1) {
                  ...
                  if (d) {
                    let a = Ot(t[n]),
                      u = o + "-" + a;
                    c.push(
                      m(Ga, { key: a, cellId: u, dayDate: t[n], todayRange: l })
                    ),
                      (d = Yr(d, r.eventOrder));
                    for (let t of d)
                      c.push(
    ...
    class ol extends ji {
      ...
      renderHScrollLayout(e, t, n, r, i, s, o) {
        ...
        let { context: l, props: c } = this,
          d = !c.forPrint && Ds(l.options),
          u = !c.forPrint && ws(l.options),
          h = [];
        e &&
          h.push({
            type: "header",
    ...
    class Dl extends On {
      constructor() {
        super(...arguments), (this.sortEventSegs = Nt(Yr));
      }
      render() {
        let { props: e, context: t } = this,
          { options: n } = t,
    ...
    class kl extends ji {
      ...
      render() {
        ...
        return m(Ji, { unit: i ? "minute" : "day" }, (a, l) =>
          m(
            _l,
            Object.assign(
    ...
    function Il(e, t, n, r, i) {
      let s = new Date(0),
        ...
        l =
          ...
          (function (e) {
            let t, n, r;
            for (t = Ol.length - 1; t >= 0; t -= 1)
              if (((n = lt(Ol[t])), (r = ft(n, e)), null !== r && r > 1))
                return n;
            return e;
          })(r),
        c = [];
